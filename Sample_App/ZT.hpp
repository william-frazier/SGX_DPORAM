...
void get(uint32_t blockID, unsigned char* data_in, int block_size, unsigned char* encrypted_request, unsigned char* tag_in, unsigned char* encrypted_response, unsigned char* tag_out, uint32_t tag_size);
